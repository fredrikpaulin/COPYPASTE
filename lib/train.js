...
function runTraining(task, trainPath, valPath, { onStdout, onStderr, onnx = false, algorithm, compare = false, search = false, grid, trainEmbeddings, valEmbeddings, dimReduce, nComponents } = {}) {
